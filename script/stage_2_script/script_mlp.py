...
if 1:
    ...
    dataset_folder_path, train_file_name, test_file_name = '../../data/stage_2_data/', 'train.csv', 'test.csv'
    data_split = True
    # load train dataset
    train_data_obj = Dataset_Loader(dName='stage 2 train dataset', dDescription='train dataset for project stage 2')
    train_data_obj.dataset_source_folder_path, train_data_obj.dataset_source_file_name = dataset_folder_path, train_file_name
    # load test dataset
